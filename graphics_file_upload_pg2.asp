...
<div class="h2 text-primary text-center"><img src="images/CL&D_graphics.png" style="margin-bottom: 10px"/>&nbsp;&nbsp;&nbsp;File&nbsp;Upload</div>
	  <div id="message_line">
		<% = message%>
	  </div>
	  ...
	  <form name="MyForm" method="post" enctype="multipart/form-data" role="form">
		...
		<div class="row">
		  <div class="col-xs-6">
			<a class="btn btn-primary btn-block" href="graphics_file_upload_pg1.asp">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
			  ...
			  <div id="summary" style="display:none">
			    ...
			    <div class="row">
				  <div class="col-xs-6"><a class="btn btn-default btn-block modalbtn" href="graphics_file_upload_pg1.asp"><span class="glyphicon glyphicon-circle-arrow-left"></span> Upload More</a></div>
				  <div class="col-xs-6"><a class="btn btn-default btn-block modalbtn" href="graphics_file_upload_redirect.asp">Done <span class="glyphicon glyphicon-ok-circle"></span></a></div>
			    </div>
			  </div>
			  <div id="fail" style="display:none">
			    <div class="row">
				  <div class="col-xs-6"><a class="btn btn-default btn-block modalbtn" href="graphics_file_upload_pg1.asp"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a></div>
