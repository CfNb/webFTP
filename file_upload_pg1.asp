...
If IsEmpty(session("sessionTime")) Then
	...
	messageButton="<a class=""btn btn-default btn-block btn-danger"" href=""file_upload.asp""><span class=""glyphicon glyphicon-refresh""></span> Reload</a></div></div></div>"
...
<noscript><!-- javascript must be enabled! -->
	<meta http-equiv="refresh" content="0;url=file_upload_noscript.asp">
</noscript>
...
<body>
	...
	<div id="uplaod_app" class="container" style="width:80%">
      <div class="h2 text-primary text-center">
      	<img src="images/CL&D_Digital.png" style="margin-bottom: 10px"/>&nbsp;&nbsp;&nbsp;&nbsp;File&nbsp;Upload
      </div>
	  <div id="message_line">
		<% = message%>
	  </div>
	
	  <form id="info-form" method="post" autocomplete="on" action="file_upload_pg2.asp" role="form">
	    <div class="row">
		...
		<div class="row">
		  <div class="col-xs-6">
			<a class="btn btn-primary btn-block" href="file_upload_redirect.asp"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</a>
		  </div>
		  <div class="col-xs-6">
