...
strRcpt = "preflight@cldgraphics.com"
...
uploaddir = "\\172.16.1.106\ftp\temp"

'Successful Uploads will be moved here
finaldir = "\\172.16.1.106\ftp\"
...
strBody = chr(13) & "CL&D Graphics WebFTP File Submittal" & chr(13)
strBody = strBody & strCommon
...
objMail.Subject = "CL&D Graphics File Upload Successful"
objMail.Body = strBody
objMail.Send
Set objMail = Nothing
