...
messageDiv="<div id=""message_text"" class=""alert alert-danger text-center"">"
	messageSpanText="<span class=""glyphicon glyphicon-alert""></span> Javascript must be enabled to upload files.<br>Please use a browser that supports HTML5.<br>Internet Explorer 8 or earlier is not supported.<br><br>"
	messageDivEnd="<div class=""row""><div class=""col-xs-offset-3 col-xs-6"">"
	messageButton="<a class=""btn btn-default btn-block btn-danger"" href=""graphics_file_upload_pg1.asp""><span class=""glyphicon glyphicon-refresh""></span> Reload</a></div></div></div>"
